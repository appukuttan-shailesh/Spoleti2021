...
#define nrn_init _nrn_init__hdpas
#define _nrn_initial _nrn_initial__hdpas
#define nrn_cur _nrn_cur__hdpas
#define _nrn_current _nrn_current__hdpas
#define nrn_jacob _nrn_jacob__hdpas
#define nrn_state _nrn_state__hdpas
#define _net_receive _net_receive__hdpas 
#define rate rate__hdpas 
#define states states__hdpas 
...
#define clk _p[2]
#define clk_columnindex 2
#define elk _p[3]
#define elk_columnindex 3
#define i _p[4]
#define i_columnindex 4
#define lk _p[5]
#define lk_columnindex 5
#define glk _p[6]
#define glk_columnindex 6
#define l _p[7]
#define l_columnindex 7
#define Dl _p[8]
#define Dl_columnindex 8
#define ghd _p[9]
#define ghd_columnindex 9
#define v _p[10]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hdpas", _hoc_setdata,
 "alpt_hdpas", _hoc_alpt,
 "alpl_hdpas", _hoc_alpl,
 "bett_hdpas", _hoc_bett,
 "rate_hdpas", _hoc_rate,
 0, 0
};
#define alpt alpt_hdpas
#define alpl alpl_hdpas
#define bett bett_hdpas
...
#define _gth 0
#define a0t a0t_hdpas
 double a0t = 0.0046;
#define ehd ehd_hdpas
 double ehd = 0;
#define gmt gmt_hdpas
 double gmt = 0.4;
#define linf_hdpas _thread1data[0]
#define linf _thread[_gth]._pval[0]
#define qtl qtl_hdpas
 double qtl = 1;
#define q10 q10_hdpas
 double q10 = 4.5;
#define taul_hdpas _thread1data[1]
#define taul _thread[_gth]._pval[1]
#define vhalft vhalft_hdpas
 double vhalft = -75;
#define zetat zetat_hdpas
 double zetat = 2.2;
#define zetal zetal_hdpas
 double zetal = 4;
 ...
 "ehd_hdpas", &ehd_hdpas,
 "vhalft_hdpas", &vhalft_hdpas,
 "a0t_hdpas", &a0t_hdpas,
 "zetal_hdpas", &zetal_hdpas,
 "zetat_hdpas", &zetat_hdpas,
 "gmt_hdpas", &gmt_hdpas,
 "q10_hdpas", &q10_hdpas,
 "qtl_hdpas", &qtl_hdpas,
 "linf_hdpas", &linf_hdpas,
 "taul_hdpas", &taul_hdpas,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 hdpas /home/shailesh/Work/Spoleti 2021/WT_3m/modeldb_ventralAD/h_pas.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shailesh/Work/Spoleti 2021/WT_3m/modeldb_ventralAD/h_pas.mod";
static const char* nmodl_file_text = 
