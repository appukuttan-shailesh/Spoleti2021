...
#define nrn_init _nrn_init__kdbm
#define _nrn_initial _nrn_initial__kdbm
#define nrn_cur _nrn_cur__kdbm
#define _nrn_current _nrn_current__kdbm
#define nrn_jacob _nrn_jacob__kdbm
#define nrn_state _nrn_state__kdbm
#define _net_receive _net_receive__kdbm 
#define rates rates__kdbm 
#define states states__kdbm 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kdbm", _hoc_setdata,
 "alpn_kdbm", _hoc_alpn,
 "betn_kdbm", _hoc_betn,
 "rates_kdbm", _hoc_rates,
 0, 0
};
#define alpn alpn_kdbm
#define betn betn_kdbm
...
#define gmn gmn_kdbm
 double gmn = 0.9;
#define ninf ninf_kdbm
 double ninf = 0;
#define nmax nmax_kdbm
 double nmax = 2;
#define q10 q10_kdbm
 double q10 = 1;
#define taun taun_kdbm
 double taun = 0;
#define vhalfn vhalfn_kdbm
 double vhalfn = -65;
#define zetan zetan_kdbm
 double zetan = 2;
 ...
 "vhalfn_kdbm", &vhalfn_kdbm,
 "a0n_kdbm", &a0n_kdbm,
 "zetan_kdbm", &zetan_kdbm,
 "gmn_kdbm", &gmn_kdbm,
 "nmax_kdbm", &nmax_kdbm,
 "q10_kdbm", &q10_kdbm,
 "ninf_kdbm", &ninf_kdbm,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdbm /home/shailesh/Work/Spoleti 2021/Tg_8m/modeldb_ventralAD/kdbm.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 44 in file kdbm.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/shailesh/Work/Spoleti 2021/Tg_8m/modeldb_ventralAD/kdbm.mod";
static const char* nmodl_file_text = 
  "TITLE  K-D channel\n"
  ": M.Migliore jun 2006\n"
  "\n"
