...
class ModelLoader(sciunit.Model,
    ...
    def __init__(self, name="model", hoc_path=None, template_name=None, mod_files_path=None):
        """ Constructor. """
        # ModelLoader(name="modeldb_ventralAD", hoc_path="./modeldb_ventralAD/cell_seed2_0.hoc", template_name="test_Wt", mod_files_path="./modeldb_ventralAD")
